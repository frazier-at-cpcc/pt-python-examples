# Cisco Packet Tracer Extensions API: MCU Class Reference
...
Writes to the mcu output. Text appears in the [MCU](class_m_c_u.html) output dialog. 
...
Writes a digital signal with the given value to the given slot. 
