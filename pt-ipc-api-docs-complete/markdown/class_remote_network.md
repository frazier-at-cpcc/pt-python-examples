# Cisco Packet Tracer Extensions API: RemoteNetwork Class Reference

Source: https://tutorials.ptnetacad.net/help/default/IpcAPI/class_remote_network.html

---

[RemoteNetwork](class_remote_network.html "RemoteNetwork handles and manipulates Multiuser remote networks.") handles and manipulates Multiuser remote networks. [More...](class_remote_network.html#details)

##  Public Member Functions  
  
---  
bool | [connect](class_remote_network.html#a4b1f6dacb1da388b7d98a6afbb743806) (QString, int, QString, QString)  
| Makes a Multiuser connection to a peer remote network. [More...](class_remote_network.html#a4b1f6dacb1da388b7d98a6afbb743806)  
  
void | [disconnect](class_remote_network.html#ad8b27e1f17345b9fca3194226c53b4c4) ()  
| Disconnects the Multiuser connection. [More...](class_remote_network.html#ad8b27e1f17345b9fca3194226c53b4c4)  
  
bool | [isConnected](class_remote_network.html#abcad82b9c442f360ff54d9526d9b118b) ()  
| Returns true if the remote network is connected, otherwise false. [More...](class_remote_network.html#abcad82b9c442f360ff54d9526d9b118b)  
  
void | [peerConnected](class_remote_network.html#ab188318c5ffd9378b1aa3a59fb95eab6) ()  
| This event is emitted when the remote network gets connected. [More...](class_remote_network.html#ab188318c5ffd9378b1aa3a59fb95eab6)  
  
void | [peerDisconnected](class_remote_network.html#a11bf9cb7411caa92b9d401b87b7c1e53) ()  
| This event is emitted when the remote network gets disconnected. [More...](class_remote_network.html#a11bf9cb7411caa92b9d401b87b7c1e53)  
  
void | [setPeerAddress](class_remote_network.html#ae145c68fc791d0443a82823d4ba176fe) (QString)  
| Sets the peer address for the outgoing connection. [More...](class_remote_network.html#ae145c68fc791d0443a82823d4ba176fe)  
  
QString | [getPeerAddress](class_remote_network.html#aa182458570e58be52e5c67ef018eba48) ()  
| Returns the peer address for the outgoing connection. [More...](class_remote_network.html#aa182458570e58be52e5c67ef018eba48)  
  
void | [setPortNumber](class_remote_network.html#a9241ef172e5d35325fa6e1e3639597a1) (int)  
| Sets the peer port number for the outgoing connection. [More...](class_remote_network.html#a9241ef172e5d35325fa6e1e3639597a1)  
  
int | [getPortNumber](class_remote_network.html#ae0b839ae6d442cb514c3629cc0705fc5) ()  
| Returns the peer port number for the outgoing connection. [More...](class_remote_network.html#ae0b839ae6d442cb514c3629cc0705fc5)  
  
void | [setConnectAsUserName](class_remote_network.html#af3924a020e01ae02e54421e3adaec450) (QString)  
| Sets the user name entered when making the outgoing connection. [More...](class_remote_network.html#af3924a020e01ae02e54421e3adaec450)  
  
QString | [getConnectAsUserName](class_remote_network.html#af6abdf6d2d6a16633d245bebfc9f06d3) ()  
| Returns the peer network name for the outgoing connection. [More...](class_remote_network.html#af6abdf6d2d6a16633d245bebfc9f06d3)  
  
void | [setPassword](class_remote_network.html#adbd6d054ba862cdc7f2cf43d973ea8f1) (QString)  
| Sets the peer password for the outgoing connection. [More...](class_remote_network.html#adbd6d054ba862cdc7f2cf43d973ea8f1)  
  
QString | [getPassword](class_remote_network.html#a3409df65912fcd82786a50f2279cfaf5) ()  
| Returns the peer password for the outgoing connection. [More...](class_remote_network.html#a3409df65912fcd82786a50f2279cfaf5)  
  
void | [setMode](class_remote_network.html#a07aa028c59e4e8cd3c739713d4006e7b) (bool)  
| Sets the Multiuser connection type to outgoing or incoming. [More...](class_remote_network.html#a07aa028c59e4e8cd3c739713d4006e7b)  
  
bool | [isOutgoing](class_remote_network.html#a07a10d51f90121f52806d0fd82a5f0db) ()  
| Returns true if the remote network is set to outgoing connection, false if incoming connection. [More...](class_remote_network.html#a07a10d51f90121f52806d0fd82a5f0db)  
...
[RemoteNetwork](class_remote_network.html "RemoteNetwork handles and manipulates Multiuser remote networks.") handles and manipulates Multiuser remote networks. 

## Member Function Documentation

## ◆ connect()

bool RemoteNetwork::connect  | ( | QString  | ,   
---|---|---|---  
|  | int  | ,   
|  | QString  | ,   
|  | QString  |   
...
Makes a Multiuser connection to a peer remote network. 

Parameters
     peerAddress,the| peer address of the peer remote network.   
---|---  
peerPort,the| peer port number of the peer remote network.   
userName,the| peer network name of the peer remote network.   
password,the| peer password of the peer remote network.  
...
Disconnects the Multiuser connection. 

## ◆ getConnectAsUserName()

QString RemoteNetwork::getConnectAsUserName  | ( | | ) |   
---|---|---|---|---  
  
Returns the peer network name for the outgoing connection. 

Returns
    QString, the peer network name for the outgoing connection. 

## ◆ getPassword()

QString RemoteNetwork::getPassword  | ( | | ) |   
---|---|---|---|---  
  
Returns the peer password for the outgoing connection. 

Returns
    QString, the peer password for the outgoing connection. 

## ◆ getPeerAddress()

QString RemoteNetwork::getPeerAddress  | ( | | ) |   
---|---|---|---|---  
  
Returns the peer address for the outgoing connection. 

Returns
    QString, the peer address for the outgoing connection. 

## ◆ getPortNumber()

int RemoteNetwork::getPortNumber  | ( | | ) |   
---|---|---|---|---  
  
Returns the peer port number for the outgoing connection. 

Returns
    int, the peer port number for the outgoing connection. 
...
Returns true if the remote network is connected, otherwise false. 

Returns
    bool, true if the remote network is connected, otherwise false. 

## ◆ isOutgoing()

bool RemoteNetwork::isOutgoing  | ( | | ) |   
---|---|---|---|---  
  
Returns true if the remote network is set to outgoing connection, false if incoming connection. 

Returns
    bool, true if the remote network is set to outgoing connection, false if incoming connection. 

## ◆ peerConnected()

void RemoteNetwork::peerConnected  | ( | | ) |   
---|---|---|---|---  
  
This event is emitted when the remote network gets connected. 

[IPC](class_i_p_c.html "IPC is the main entry point for all IPC functionality.") event. 

## ◆ peerDisconnected()

void RemoteNetwork::peerDisconnected  | ( | | ) |   
---|---|---|---|---  
  
This event is emitted when the remote network gets disconnected. 

[IPC](class_i_p_c.html "IPC is the main entry point for all IPC functionality.") event. 

## ◆ setConnectAsUserName()

void RemoteNetwork::setConnectAsUserName  | ( | QString  | | ) |   
---|---|---|---|---|---  
  
Sets the user name entered when making the outgoing connection. 
...
void RemoteNetwork::setMode  | ( | bool  | | ) |   
---|---|---|---|---|---  
  
Sets the Multiuser connection type to outgoing or incoming. 

Parameters
     bOutgoing,true| for outgoing connection, false for incoming connection.   
---|---  
  
## ◆ setPassword()

void RemoteNetwork::setPassword  | ( | QString  | | ) |   
---|---|---|---|---|---  
  
Sets the peer password for the outgoing connection. 

Parameters
     password,the| peer password for the outgoing connection.   
---|---  
  
## ◆ setPeerAddress()

void RemoteNetwork::setPeerAddress  | ( | QString  | | ) |   
---|---|---|---|---|---  
  
Sets the peer address for the outgoing connection. 

Parameters
     address,the| peer address for the outgoing connection.   
---|---  
  
## ◆ setPortNumber()

void RemoteNetwork::setPortNumber  | ( | int  | | ) |   
---|---|---|---|---|---  
  
Sets the peer port number for the outgoing connection. 

Parameters
     port,the| peer port number for the outgoing connection.   
---|---  
