# Cisco Packet Tracer Extensions API: Pc Class Reference

Source: https://tutorials.ptnetacad.net/help/default/IpcAPI/class_pc.html

---

[Pc](class_pc.html "Pc is PC device object with a terminal line.") is PC device object with a terminal line. [More...](class_pc.html#details)
...
[Pc](class_pc.html "Pc is PC device object with a terminal line.") is PC device object with a terminal line. 

## Member Function Documentation

## ◆ getCommandPrompt()

[TerminalLine](class_terminal_line.html) Pc::getCommandPrompt  | ( | | ) |   
---|---|---|---|---  
  
Returns the command prompt of the PC. 
...
Returns true if DHCP is enabled, otherwise false. 

Parameters
     bool,true| if DHCP is enabled, otherwise false.   
---|---  
  
## ◆ getRs232Port()

[Port](class_port.html) Pc::getRs232Port  | ( | | ) |   
---|---|---|---|---  
  
Returns the RS232 port. 

Returns
    [Port](class_port.html "Port holds and manipulates the ports on devices."), the [Port](class_port.html "Port holds and manipulates the ports on devices.") object of the RS232 port. 

## ◆ setDefaultGateway()

void Pc::setDefaultGateway  | ( | ip  | | ) |   
---|---|---|---|---|---  
...
void Pc::setDhcpFlag  | ( | bool  | | ) |   
---|---|---|---|---|---  
  
Enables or disables DHCP. 

Parameters
     status,true| to enable DHCP, false to disable it.   
---|---  
