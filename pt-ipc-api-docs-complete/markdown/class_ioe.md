# Cisco Packet Tracer Extensions API: Ioe Class Reference

Source: https://tutorials.ptnetacad.net/help/default/IpcAPI/class_ioe.html
...
---  
bool | [getComparatorTree](class_ioe.html#a7ac48ace0fcf182a4aa892289e4542bb) ([TreeNode](class_tree_node.html))  
| This delegate get the comparator tree and returns true if successful, otherwise false. [More...](class_ioe.html#a7ac48ace0fcf182a4aa892289e4542bb)  
  
bool | [checkComparatorTree](class_ioe.html#aa413ff108ea6bb8189adec5037938e9a) ([TreeNode](class_tree_node.html), [Ioe](class_ioe.html))  
| This delegate check the comparator tree and returns true if successful, otherwise false. [More...](class_ioe.html#aa413ff108ea6bb8189adec5037938e9a)  
  
string | [getSensorType](class_ioe.html#af9fc884802aaee1dae91b2cbe7b52ff4) ()  
| Returns sensor type string. [More...](class_ioe.html#af9fc884802aaee1dae91b2cbe7b52ff4)  
  
bool | [getSensorState](class_ioe.html#a1505024fd9797a59721325897f372ce1) ()  
| Returns true if can get sensor state, false otherwise. [More...](class_ioe.html#a1505024fd9797a59721325897f372ce1)  
...
bool Ioe::checkComparatorTree  | ( | [TreeNode](class_tree_node.html) | ,   
---|---|---|---  
|  | [Ioe](class_ioe.html) |   
| ) | |   
  
This delegate check the comparator tree and returns true if successful, otherwise false. 

  * treeNode, the tree. 
  * answer, the answer IoE device.
...
bool Ioe::getComparatorTree  | ( | [TreeNode](class_tree_node.html) | | ) |   
---|---|---|---|---|---  
  
This delegate get the comparator tree and returns true if successful, otherwise false. 
...
bool Ioe::getSensorState  | ( | | ) |   
---|---|---|---|---  
  
Returns true if can get sensor state, false otherwise. 

Returns
    bool, true if can get sensor state, false otherwise. 

## ◆ getSensorType()

string Ioe::getSensorType  | ( | | ) |   
---|---|---|---|---  
  
Returns sensor type string. 
